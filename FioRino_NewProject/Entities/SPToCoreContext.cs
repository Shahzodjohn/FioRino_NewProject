...
///
/// generated by SPToCore on 02/07/2022 11:32:39
///
...
namespace FioRino_NewProject.Model
{
    public partial class SPToCoreContext : FioRinoBaseContext
    {
        ...
        private DbSet<EXPOSE_dm_Users_GetByEmailResult> EXPOSE_dm_Users_GetByEmail { get; set; }
        ...
        {            
            ...
            modelBuilder.Entity<EXPOSE_dm_Users_GetByEmailResult>().HasNoKey();
        ...
        public async Task<List<EXPOSE_dm_Users_GetByEmailResult>> EXPOSE_dm_Users_GetByEmailAsync(string Email)
        {
            //Initialize Result 
            List<EXPOSE_dm_Users_GetByEmailResult> lst = new List<EXPOSE_dm_Users_GetByEmailResult>();
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_Users_GetByEmail] @Email";
                
                //Output Data
                lst = await this.EXPOSE_dm_Users_GetByEmail.FromSqlRaw(sqlQuery , p_Email ).ToListAsync();
        ...
        public class EXPOSE_dm_Users_GetByEmailResult
        {
