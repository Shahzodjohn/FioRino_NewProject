...
///
/// generated by SPToCore on 12/06/2021 12:11:53
///
...
namespace FioRino_web.Model
{
    public partial class SPToCoreContext : FioRinoBaseContext
    {
        ...
        public void EXPOSE_dm_Order_UpdateIsInMagazynTrue(int? OrderId)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_Order_UpdateIsInMagazynTrue] @OrderId";
                //Execution
        ...
        public void EXPOSE_dm_OrderArchievum_SelectingALLFormAchievum()
        {
        ...
        public void EXPOSE_dm_OrderProducts_PersonalWzDetails(int? OrderId)
        {
        ...
        public void EXPOSE_dm_Orders_CreateOrder(DateTime? CreatedAt,DateTime? UpdatedAt,int? OrderStatusId,bool? Is_InMagazyn,int? SenderId,int? Amount,string SourceOfOrder,string OrderExecutor,ref int? OrderId)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_Orders_CreateOrder] @CreatedAt, @UpdatedAt, @OrderStatusId, @Is_InMagazyn, @SenderId, @Amount, @SourceOfOrder, @OrderExecutor, @OrderId OUTPUT";
                //Execution
                this.Database.ExecuteSqlRaw(sqlQuery , p_CreatedAt , p_UpdatedAt , p_OrderStatusId , p_Is_InMagazyn , p_SenderId , p_Amount , p_SourceOfOrder , p_OrderExecutor , p_OrderId );
        ...
        public void EXPOSE_dm_WzMagazyn_ListOfWzOrdersInWZMAGAZYN(int? WzMagazynId)
        {
